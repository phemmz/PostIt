...
describe('/POST User', () => {
  it('it should not POST signup details without email', (done) => {
    ...
    chai.request(server).post('/api/user/signup').send(signupDetails).end((err, res) => {
...
//    it('it should not allow users create
//    broadcast groups without providing groupname', (done) => {
//      let groupDetails = {
//      }
//      chai.request(server)
//      .post('/api/group')
