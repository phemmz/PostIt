...
describe('Message Reducer', () => {
  it(`should handle GROUP_MESSAGES by
   setting all messages in a group to the state`, () => {
  ...
  it(`should handle NO_GROUP_MESSAGES
   when there is no messages in a group`, () => {
  ...
  it('should handle SEND_MESSAGE for sending a message', () => {
